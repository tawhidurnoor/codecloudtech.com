...
!(function (t, o) {
    ...
    return (function (t) {
        ...
        return (
            ...
            (e.d = function (t, o, n) {
                e.o(t, o) ||
                    Object.defineProperty(t, o, { enumerable: !0, get: n });
            }),
            (e.r = function (t) {
                    ...
                    t
                        ...
                        e.off("change").on("change", function () {
                            ...
                            /audio/.test(t.type)
                                ...
                                : alert(
                                      "Your selected file is not an audio file!"
                                  );
                        }),
                                ...
                                if (((e = e.split("-")), t.attr("class")))
                                    if (t.hasClass("fb-button"))
                                        ...
                                        var n = t.children("label"),
                                            ...
                                            a = t.children("div");
                                        n.addClass(
                                            "control-label col-sm-".concat(e[0])
                                        ),
                                            a.length > 0
                                                ? a.addClass(
                                                      "col-sm-".concat(e[1])
                ...
                showSettingForm: function (t, o, e) {
                    ...
                    n.hasClass("form-inline")
                        ...
                        t
                            ...
                            .css(
                                "display",
                                "form-horizontal" === i ? "block" : "none"
                            ),
                        t
                            .find(".select-grid")
                            .val(n.attr("data-grid") || "4-8");
                },
            }),
                (i.a.components.googlemap = {
                    ...
                    initSettingForm: function (t, o) {
                        t.append(
                            ...
                            t
                                .find(".btn-googlemap-edit")
                                .on("click", function (t) {
                                    t.preventDefault();
                                    var e = prompt(
                                            "Please enter Google Map embed code in here:"
                                        ),
                                        n = r()(e),
                                        i = n.attr("src");
                                    n.length > 0 && i && i.length > 0
                                        ? o
                                              ...
                                              .attr("src", i)
                                        : alert(
                                              "Your Google Map embed code is invalid!"
                                          );
                                }),
                            t
                                .find(".btn-googlemap-169")
                                .on("click", function (t) {
                                    t.preventDefault(),
                                        o
                                            .getSettingComponent()
                ...
                (i.a.components.photo = {
                    ...
                    initSettingForm: function (t, o) {
                        ...
                        n.on("click", function (t) {
                            ...
                            t.preventDefault();
                            var e = prompt("Please enter Image URL in here:");

                            if (e.match(/\.(jpeg|jpg|gif|png|webp)$/) != null) {
                                o.getSettingComponent()
                                    .find("img")
                                    .attr("src", e)
                                    .css({ width: "", height: "" });
            ...
            (c.a.disableAutoInline = !0),
                ...
                (i.a.components.text = {
                    options: {
                        ...
                        removePlugins:
                            "table,magicline,tableselection,tabletools",
                        removeButtons:
                ...
                (i.a.components.video = {
                    init: function (t, o, e, n) {
                        var i = e
                            .children(".keditor-component-content")
                            .find("video");
                        ...
                        t.find(".btn-video-input").on("click", function (t) {
                            ...
                            e.on("change", function () {
                                ...
                                /video/.test(t.type)
                                    ...
                                    : alert(
                                          "Your selected file is not an video file!"
                                      );
                            }),
                    ...
                    showSettingForm: function (t, o, e) {
                        ...
                        t
                            .find(".video-autoplay")
                            .prop("checked", n.prop("autoplay")),
                            t
                                .find(".video-loop")
                                .prop("checked", n.prop("loop")),
                            t
                                .find(".video-ratio")
                                .prop("checked", !1)
                                .filter(
                                    '[value="' + n.attr("data-ratio") + '"]'
                                )
                                .prop("checked", !0),
                            t
                                .find(".video-controls")
                                .prop("checked", n.prop("controls")),
                    ...
                    initSettingForm: function (t, o) {
                        t.append(
                            ...
                            t.find(".btn-vimeo-edit").on("click", function (t) {
                                t.preventDefault();
                                var e = prompt(
                                    "Please enter Vimeo URL in here:"
                                ).match(
                ...
                (i.a.components.youtube = {
                    ...
                    initSettingForm: function (t, o) {
                        t.append(
                            ...
                            t
                                .find(".btn-youtube-edit")
                                .on("click", function (t) {
                                    t.preventDefault();
                                    var e = prompt(
                                        "Please enter Youtube URL in here:"
                                    ).match(
