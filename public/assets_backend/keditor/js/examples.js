(function ($) {
    ...
    function initToolbar() {
        ...
        var btnViewSource = $(
            '<button type="button" class="view-source"><i class="fa fa-code"></i> View source</button>'
        );
        var btnViewContent = $(
        ...
        btnViewContent.on("click", function () {
            ...
            modal
                .find(".content-html")
                .html(beautifyHtml($("#content-area").keditor("getContent")));
    ...
    function initModalSource() {
        ...
        var htmlInclude = $("<div />")
            .html($('[data-keditor="html-include"]').clone())
            .html();
