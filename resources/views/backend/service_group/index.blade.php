...
@section('title')
    <title>Service Group | CodeCloud Technology CMS</title>
@endsection
    ...
    <div id="add-modal" class="modal fade" tabindex="-1" aria-labelledby="add-modal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.service_group.store') }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="service_type" class="form-select mr-sm-2" required>
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('admin.service_group.store') }}" id="edit-form" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label>Service Type</label>
                            <select name="service_type" id="service_type" class="form-select mr-sm-2" required>
                                <option selected="">Choose...</option>
                                <option value="Virtual">Virtual</option>
                                <option value="Physical">Physical</option>
                            </select>
